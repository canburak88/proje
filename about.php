...
<div id="sayfaUst">
    ...
    <div id="icerik">
        <h1>Hakkında</h1>
        <p>Donanım ve yazılımın bir veya daha fazla yapılandırması o programı çalıştırmak için bir tür yol sağlar. Programlama dili uygulamasında iki yaklaşım vardır: Derleme ve yorumlama. Herhangi bir tekniği kullanarak bir programlama dili uygulamak mümkündür.
            ...
            Cihaza komut göndermeyi sağlayan, verileri cihaza aktarma stilidir. Şu anda hemen hemen tüm yazılım dilleri İngilizcedir. Bazı uygulamaların dili ise İspanyolca olarak kullanılmaya başlanmıştır.</p>
    </div>
</div>
<div id="sayfaAlt">
    <div id="footer">
